...
function setup()
{
    ...
    movement2 = Math.floor(Math.random() * 5) + 1;
    movement3 = Math.floor(Math.random() * 5) + 1;
    movement4 = Math.floor(Math.random() * 5) + 1;
    movement5 = Math.floor(Math.random() * 5) + 1;
    movement6 = movement5
}
...
function draw()
{
    ...
    fill(0);
    /* I decided to remove the signature size flux, but left in
    the code to put it back in if wanted in the future 
    to put back text size flux, change textSize(10); to textSize(size);
    */
    textSize(14); 
